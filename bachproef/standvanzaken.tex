...
Deze sectie beschrijft sommige z/OS-concepten die nodig zijn om z/OS omgeving en taken van system administrators te begrijpen.
...
Deze zijn gespecialiseerde subsystemen in z/OS en een system administrator moet deze subsystemen weten en begrijpen. In deze bachelorproef gaat er minder aandacht besteed worden op deze subsystemen.
\begin{itemize}
...
\subsection{De evoluerende rol van de System Administrator}
...
Het European e-Competence Framework (e-CF) is een Europees referentiekader dat ICT-competenties structureert in termen van kennis, vaardigheden en autonomie. Het framework werd ontwikkeld onder auspiciën van CEN (European Committee for Standardization) en heeft als doel een gemeenschappelijke taal te bieden voor ICT-rollen binnen Europa. \autocite{eCF_framework}
