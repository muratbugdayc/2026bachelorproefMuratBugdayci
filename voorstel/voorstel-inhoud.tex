...
Deze complexiteit wordt verder versterkt door de nauwe samenwerking tussen verschillende subsystemen en het centrale workloadmanagement binnen z/OS, waarbij resources dynamisch worden toegewezen op basis van prioriteit en systeemstatus \autocite{IBMZOSArchitectureWLM}.
...
Uit de geraadpleegde literatuur blijkt dat mainframe- en z/OS-omgevingen gekenmerkt worden door een hoge mate van complexiteit en een sterke afhankelijkheid van gespecialiseerde kennis \autocite{IBMABCsZOSV1}. De rol van de System Administrator binnen deze context is essentieel voor het waarborgen van stabiliteit, veiligheid en continuïteit van bedrijfskritische systemen.
